...
$source=$_GET['source'] ?? '';
$page=$_GET['page'] ?? '';
if(!$source or ($source <> 'member')and ($source <> 'admin') ){
        ...
        <table align="center" border="1" style="border-collapse:collapse" cellpadding="10" cellspacing="0";>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <input  name="fav[]" type="checkbox" <?php if(in_array('踢足球',$fav)){echo 'checked';} ?>  value="踢足球">踢足球</td>
            </tr>

            <tr>
                <td align="right"><input type="submit" value="提交"></td>
                <td align="left"><input type="reset" value="重置" ></td>
                <input type="hidden" name="sourece" value="<?php echo $info['sourece']; ?>">
                <input type="hidden" name="page" value="<?php echo $info['page']; ?>">
            </tr>
        </table>
    </form>
</div>
